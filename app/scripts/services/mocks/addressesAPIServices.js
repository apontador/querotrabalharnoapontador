(function(){   
  ...
  angular.module('mockServices').run(function($httpBackend) {
      ...
      $httpBackend.whenGET('https://api.apontador.com.br/v2/addresses?access_token=5a3e7dd1-c07e-4949-8450-1fdec266731e&fl=description&fq=state:SP&q=Avenida+Pedro+%C3%81lvares+Cabral').respond(result);
  });
