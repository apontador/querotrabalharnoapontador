(function(){   
  ...
  .constant('placeAPIServicesMocks', {
    'place': {
        'id': 'B37822W2',
        'link': {
            'rel': 'self',
        ...
        'phones': ['551155745045', '551155734180'],
        ...
        'categories': [
            {
                ...
                'subcategory': {'id': '64', 'name': 'Parques', 'vanityName': 'parques'},
                'restrict': false,
                'quotationRadius': 0
            }
        ],
        ...
        'openingHours': {
            'periods': [
                ...
                },
                {
                    ...
                    'close': {'day': 7, 'time': '0000'}
                },
                {
                    'open': {'day': 7, 'time': '0500'},
